...
// Google Calendar Setup (Exakt aus deiner Basis übernommen)
...
// --- HILFSFUNKTIONEN (1:1 aus deiner Basis) ---
...
async function handleChat(chatId, text) {
  ...
  // Original Fetching (Exakt wie in deiner Basis)
  ...
  if (session) {
    ...
    const extraction = await openai.chat.completions.create({
        model: "gpt-4o",
        messages: [{ role: "system", content: "Extrahiere Labelcopy Felder als JSON. 'Abmischung' -> Mixed by etc. Gib NUR JSON." }, { role: "user", content: text }],
